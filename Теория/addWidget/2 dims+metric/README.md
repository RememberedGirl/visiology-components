...
*   **Цвет столбцов:** единый цвет из `widgetColors[0]`
...
*   **Максимальная ширина столбцов:** 40px

## 4. Структура данных

### Измерения:
*   **Измерение[0]:** Первое измерение для группировки (keys[0])
*   **Измерение[1]:** Второе измерение для детализации (keys[1])
*   **Измерение[N]:** Дополнительные измерения (keys[N])
