...
**2. Цветовая схема:**
"Каждый показатель имеет уникальный цвет из палитры widgetColors (циклическое использование)"

**3. Размеры и масштабирование элементов:**
"Высота столбцов пропорциональна значениям показателей"

### Функциональность:

**5. Легенда и вспомогательные элементы:**
"Легенда для переключения видимости показателей"
...
### Показатели:
- **Показатель[N]:** Значения для столбцов, где N = 0,1,2,... (любое количество)
