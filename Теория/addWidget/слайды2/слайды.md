...
**1. Компоновка:**
"Вертикальная столбчатая диаграмма с иерархической группировкой по измерениям"

**2. Цветовая схема:**
"Все столбцы одного цвета - widgetColors[0]"

**3. Подписи и текст:**
"Подписи на оси X формируются как комбинация всех измерений через разделитель"
"Отображать значения Показатель[0] над столбцами"
...
- **Измерение[N]:** Дополнительные измерения, где N = 0,1,2,... (любое количество)
