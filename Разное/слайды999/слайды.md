...
## 2. Тип визуализации
**График японских свечей (Candlestick)**

## 3. Желаемый результат

Создай интерактивный график японских свечей для отображения финансовых данных. График должен показывать ценовые движения за временные периоды.

### Визуальные характеристики:
*   **Восходящие свечи:** зеленый цвет (закрытие > открытия)
*   **Нисходящие свечи:** красный цвет (закрытие < открытия)
*   **Всплывающие подсказки:** показывать дату, цены открытия, закрытия, максимума и минимума

## 4. Структура данных

### Измерения:
*   **Измерение[0]:** Дата/временной период (ось X)

### Показатели:
*   **Показатель[0]:** Цена открытия
*   **Показатель[1]:** Цена закрытия
*   **Показатель[2]:** Минимальная цена
*   **Показатель[3]:** Максимальная цена
